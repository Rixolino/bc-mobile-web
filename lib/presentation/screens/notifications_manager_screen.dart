      ...
      child: Scaffold(
        ...
        body: Consumer<NotificationManagerProvider>(
          builder: (context, vm, child) {
            ...
            // Card fermate (logica invariata, solo estratte per layout responsive).
            final stopCards = vm.stops.map((s) => Dismissible(
                  ...
                  child: Container(
                    margin: EdgeInsets.symmetric(
                        horizontal: isLandscape ? 0 : 16, vertical: 8),
                    decoration: BoxDecoration(
            ...
            final tripCards = vm.trips.map((t) => Dismissible(
            ...
            final stationCards = vm.stations.map((sid) => Dismissible(
            ...
            Widget sectionGrid(List<Widget> cards) {
              if (!isLandscape || cards.isEmpty) {
                  ...
                  child: ListView(
                    ...
                    children: [
                      Container(
                        ...
                        child: SafeArea(
                          child: Padding(
                            padding: EdgeInsets.all(isLandscape ? 14.0 : 20.0),
                            child: Column(
